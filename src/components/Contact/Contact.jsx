            ...
            <section className="container mx-auto px-6 py-12">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <h2 className="text-2xl text-gray-700 font-bold mb-4 text-center">Contact Us</h2>
                            ...
                            <div className="mt-8 flex justify-center">
                                <button
                                    type="submit"
                                    className="font-semibold text-lg text-white hover:text-black px-3 py-2 bg-gray-700 hover:bg-gray-200 rounded-lg transform duration-500"
                                >
                                    Submit
                                </button>
                            </div>
