                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                        ...
                        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 h-full flex flex-col justify-between pointer-events-none">
                            <div className="h-1 w-8 bg-gray-300 mx-auto rounded">  hhhj</div>
                            <div className="h-8 w-8 bg-gray-300 mx-auto rounded-full"></div>
                            <div className="h-1 w-8 bg-gray-300 mx-auto rounded"></div>
                        </div>

                        {/* <!-- Understanding --> */}
                        <div className="flex flex-col items-center bg-white p-8 rounded-lg shadow-lg transition-transform transform hover:scale-105 relative z-10">
                        ...
                        <div className="flex flex-col items-center bg-white p-8 rounded-lg shadow-lg transition-transform transform hover:scale-105 relative z-10">
                            ...
                            {/* <p className="text-gray-700">Reporting.</p> */}
                        </div>
            ...
            <section className="mb-12  py-12">
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {/* Method 1 */}
                        <div className="relative flex flex-col items-center bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl hover:-translate-y-2 animate-fade-in animation-delay-200">
                        ...
                        {/* Method 2 */}
                        <div className="relative flex flex-col items-center bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl hover:-translate-y-2 animate-fade-in animation-delay-400">
                        ...
                        {/* Method 3 */}
                        <div className="relative flex flex-col items-center bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl hover:-translate-y-2 animate-fade-in animation-delay-600">
                        ...
                        {/* Method 4 */}
                        <div className="relative flex flex-col items-center bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl hover:-translate-y-2 animate-fade-in animation-delay-800">
                        ...
                        {/* Method 5 */}
                        <div className="relative flex flex-col items-center bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl hover:-translate-y-2 animate-fade-in animation-delay-1000">
                        ...
                        {/* Method 6 */}
                        <div className="relative flex flex-col items-center bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl hover:-translate-y-2 animate-fade-in animation-delay-1200">
                        ...
                        {/* Method 7 */}
                        <div className="relative flex flex-col items-center bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl hover:-translate-y-2 animate-fade-in animation-delay-1400">
