    ...
    <footer className="bg-blue-100 text-white py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="footer-col text-xs md:text-sm">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/team" className="text-black hover:text-white">Our Team</a></li>
              <li><a href="/contact" className="text-black hover:text-white">Contact Us</a></li>
              <li><a href="/career" className="text-black hover:text-white">Careers</a></li>
            </ul>
          </div>
          ...
          <div className="footer-col text-xs md:text-sm">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/client" className="text-black hover:text-white">Clients</a></li>
            </ul>
          </div>
          {/* Column 3 - Our Work */}
          <div className="footer-col text-xs md:text-sm">
            ...
            <ul className="space-y-2 block md:hidden">
              <li className='text-black flex items-center gap-2'><Mail size={13}/> info@futurity.co.in</li>
              <li className='text-black flex items-center gap-2'><Phone size={13}/>+91-9811284282</li>
              <li className='text-black flex items-center gap-2'><MapPin  size={13}/> <p> E-12, 2nd Floor, Naraina<br />Vihar, New Delhi 110028</p>  </li>
              
            </ul>
            <ul className="space-y-2 hidden md:block">
              <li className='text-black flex items-center gap-2'><Mail size={20}/> info@futurity.co.in</li>
              <li className='text-black flex items-center gap-2'><Phone size={20}/>+91-9811284282</li>
              <li className='text-black flex items-center gap-2 text-sm'><MapPin size={20}/><p> E-12, 2nd Floor, Naraina<br />Vihar, New Delhi 110028</p></li>
            </ul>
          </div> 
        ...
        <div className="footer-bottom mt-8 border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-black">© Futurity 2024. All Rights Reserved.</p>
          <div className="footer-links mt-4 md:mt-0 flex space-x-4 text-xs md:text-base">
            <a href="/" className="text-black hover:text-white">Privacy Policy</a>
            <a href="/" className="text-black hover:text-white">Terms of Service</a>
            <a href="/" className="text-black hover:text-white">Security</a>
          </div>
        </div>
      </div>
    </footer>
