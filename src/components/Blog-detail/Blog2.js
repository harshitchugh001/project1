          ...
          <Div className="col-lg-8">
            ...
            <Div className="cs-post cs-style2">
              <Div className="cs-post_thumb cs-radius_15">
                <img src="/images/blog2.png" alt="Post" className="w-100 cs-radius_15" />
              </Div>
              <Div className="cs-post_info">
                <Div className="cs-post_meta cs-style1 cs-ternary_color cs-semi_bold cs-primary_font">
                  <span className="cs-posted_by">05 Mar 2024</span>
                  <Link to="/blog" className="cs-post_avatar">Marketing</Link>
                </Div>
                <h2 className="cs-post_title">Crafting Success: Essential Strategies for Small Businesses in Social Media Marketing</h2>
                <p>Crafting a successful social media strategy for small businesses involves a nuanced understanding of various elements that contribute to effective online marketing. It's not just about being present on social media; it's about creating a narrative that resonates with your audience and aligns with your business goals.</p>
                ...
                <Div className="row">
                  <Div className="col-md-6">
                    <img src="/images/blog2-1-1.png" alt="Blog Details" className="cs-radius_15 w-100" />
                    <Div className="cs-height_45 cs-height_lg_45" />
                  </Div>
                  <Div className="col-md-6">
                    <img src="/images/blog2-1-2.png" alt="Blog Details" className="cs-radius_15 w-100" />
                    <Div className="cs-height_45 cs-height_lg_45" />
                  </Div>
                </Div>
